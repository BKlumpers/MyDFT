...
double two_electronGTO(GTO GTO1, GTO GTO2, GTO GTO3, GTO GTO4)
{
    ...
    vector<double> arrBx(imaxX,0);
    //vector<double> darrBx(imaxX,0);
            ...
            for(int r1=0; r1 < i1/2+1; r1++) {
                for(int r2=0; r2 < i2/2+1; r2++) {
                    for(int u=0; u<(i1+i2)/2-r1-r2+1; u++) {
                        ...
                        arrBx[i] += electricComponent(i1,i2,r1,r2,u,GTO1.a,GTO2.a,GTO3.a,GTO4.a,GTO1.atompos[0],GTO2.atompos[0],GTO3.atompos[0],GTO4.atompos[0],rp[0],rq[0],gamma12,gamma34,delta);
                        //darrBx[i] += B_term(i1,i2,r1,r2,u,GTO1.a,GTO2.a,GTO3.a,GTO4.a,rp[0],GTO1.atompos[0],GTO2.atompos[0],rq[0],GTO3.atompos[0],GTO4.atompos[0],gamma12,gamma34,delta);
                    }   
                }
            }
        }
    ...
    vector<double> arrBy(imaxY,0);
    //vector<double> darrBy(imaxY,0);
        ...
        for(int i2=0; i2<GTO3.b+GTO4.b+1; i2++) {
            for(int r1=0; r1 < i1/2+1; r1++) {
                for(int r2=0; r2 < i2/2+1; r2++) {
                    for(int u=0; u<(i1+i2)/2-r1-r2+1; u++) {
                        int i = i1+i2-2*(r1+r2)-u;
                        arrBy[i] += electricComponent(i1,i2,r1,r2,u,GTO1.b,GTO2.b,GTO3.b,GTO4.b,GTO1.atompos[1],GTO2.atompos[1],GTO3.atompos[1],GTO4.atompos[1],rp[1],rq[1],gamma12,gamma34,delta);
                        //darrBy[i] += B_term(i1,i2,r1,r2,u,GTO1.b,GTO2.b,GTO3.b,GTO4.b,rp[1],GTO1.atompos[1],GTO2.atompos[1],rq[1],GTO3.atompos[1],GTO4.atompos[1],gamma12,gamma34,delta);
                    }
                }
            }
        }
    ...
    vector<double> arrBz(imaxZ,0);
    //std::vector<double> darrBz(imaxZ,0);
        ...
        for(int i2=0; i2<GTO3.c+GTO4.c+1; i2++) {
            for(int r1=0; r1 < i1/2+1; r1++) {
                for(int r2=0; r2 < i2/2+1; r2++) {
                    for(int u=0; u<(i1+i2)/2-r1-r2+1; u++) {
                        int i = i1+i2-2*(r1+r2)-u;
                        arrBz[i] += electricComponent(i1,i2,r1,r2,u,GTO1.c,GTO2.c,GTO3.c,GTO4.c,GTO1.atompos[2],GTO2.atompos[2],GTO3.atompos[2],GTO4.atompos[2],rp[2],rq[2],gamma12,gamma34,delta);
                        //darrBz[i] += B_term(i1,i2,r1,r2,u,GTO1.c,GTO2.c,GTO3.c,GTO4.c,rp[2],GTO1.atompos[2],GTO2.atompos[2],rq[2],GTO3.atompos[2],GTO4.atompos[2],gamma12,gamma34,delta);
                    }
                }
            }
        }
    ...
    for(int i=0; i<=(GTO1.a+GTO2.a+GTO3.a+GTO4.a); i++) {
        for(int j=0; j<=(GTO1.b+GTO2.b+GTO3.b+GTO4.b); j++) {
            for(int k=0; k<=(GTO1.c+GTO2.c+GTO3.c+GTO4.c); k++) {
                sum += arrBx[i]*arrBy[j]*arrBz[k]*fmch(i+j+k,0.25*Rpq_2/delta);
                //dsum += darrBx[i]*darrBy[j]*darrBz[k]*fmch(i+j+k,0.25*Rpq_2/delta);
            }
        }
    }

    return sum*prefactor*GTO1.getnorm()*GTO2.getnorm()*GTO3.getnorm()*GTO4.getnorm();
}
